    ...
    <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php endif; ?>
                <a class="collapse-item" href="<?=base_url('/author/manageArtikel')?>">Manage Artikel</a>
                <a class="collapse-item" href="<?=base_url('/author/manageKomen')?>">Manage Komen</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?=base_url('/author/create_artikel')?>">Create</a>
            </div>
        </div>
    </li>
