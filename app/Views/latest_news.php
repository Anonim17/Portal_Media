            ...
            <div class="col-lg-8 mb-5 mb-lg-0">
                <div class="blog_left_sidebar">
                    ...
                    <nav class="blog-pagination justify-content-center d-flex">
                        <ul class="pagination">
                            <li class="page-item">
                                <a <?php if($page > 1){ echo "href='?page=$previous'"; } ?> class="page-link" aria-label="Previous">
                            ...
                            <?php }?>	
                            <li class="page-item">
                                <a <?php if($page < $total_page) { echo "href='?page=$next'"; } ?> class="page-link" aria-label="Next">
